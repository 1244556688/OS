...
export default function App() {
  ...
  const runGitHubActionsPipeline = () => {
    ...
    const logSteps = [
      ...
      { text: '🔧 APT-GET: Installing compiler tooling (nasm, gcc-multilib, grub-pc-bin, grub-efi-amd64-bin, xorriso, mtools)...', delay: 1100 },
      ...
      { text: '📂 ISO: Generating clean, pure standard grub.cfg to prevent "no console will be available to OS" warnings...', delay: 4900 },
